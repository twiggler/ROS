...
namespace rlib {
    ...
    public:
        RefAllocator(BaseAllocator& ref) : ref(&ref) {}
    private:
        BaseAllocator* ref;
        ...
        virtual bool do_owns(void* p) const final { return ref->owns(p); }
    };
    ...
    private:
        ...
        virtual bool do_owns(void* p) const final { return primary.owns(p) || secondary.owns(p); }
    };
